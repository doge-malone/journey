  ...
  return (
    <VStack className={styles.container}>
      <VStack className={styles.questContainer}>
        <HStack pb="1rem" gap={2}>
          ...
          <VStack className={styles.questTitleContainer}>
            <Text className={styles.questTitle}>Master Trading on Waves</Text>
            <Text className={styles.questSubtitle}>
              Master the core DeFi trading platforms available on Waves
            </Text>
          </VStack>
        </HStack>
      ...
      <VStack gap={10}>
        {fetchedJourney.map(
          (
            { title, description, nft_reward, completed_users, partner, id },
            idx
          ) => (
        ...
        <VStack pb="5rem">
          <RewardPill label="Achievement: Waves Trading Expert" />
